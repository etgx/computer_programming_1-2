...
public:
    ...
    // get information of this tower
    int get_frequency() {return this->attack_frequency;};
    int get_harm_point(){return this->attack_harm_point;};
    int get_velocity(){return this->attack_velocity;};
